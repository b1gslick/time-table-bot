...
var messages = map[string]map[string]string{
	LangRU: {
		...
		"service_add_usage":       "Формат: /service_add 30 Название услуги",
	...
	LangEN: {
		...
		"service_add_usage":       "Usage: /service_add 30 Service name",
