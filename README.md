...
Командные форматы поддерживаются как fallback: `/schedule 2026-06`, `/service_add 30 Категория > Подкатегория > Название`, `/service_delete 2`, `/generate 2026-06 2`, `/calendar_delete 2026-06`, `/appoint @username YYYY-MM-DD HH:MM`, `/book YYYY-MM-DD HH:MM`, `/move FROM_DATE FROM_TIME TO_DATE TO_TIME`.
